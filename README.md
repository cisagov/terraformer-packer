...
This project can be used to build a Debian AMI with both
[Terraform](https://www.terraform.io/) and
[`terraform-docs`](https://terraform-docs.io/) installed.
...
secrets on the
[appropriate page](https://github.com/cisagov/terraformer-packer/settings/secrets)
...
```console
[build-terraformer-packer]
aws_access_key_id = AKIAXXXXXXXXXXXXXXXX
aws_secret_access_key = XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX

[cool-images-ec2amicreate-terraformer-packer]
role_arn = arn:aws:iam::111111111111:role/EC2AMICreate-build-terraformer-packer
source_profile = build-terraformer-packer
